...
class SentenceClassifier(nn.Module):
    ...
    def __init__(self, args):
        ...
        C = args.CLASS_NUM # classification class type num
        Ci = 1 # the number of channels in the input
        Co = args.OUTPUT_CHANNEL_NUM # Number of channels produced by the convolution
        Ns = args.N_GRAM_LIST # list of the number of words (N-gram) EX. [2 3 5]
        ...
        self.dropout = nn.Dropout(args.DROPOUT_RATE) # the probability for dropout
...
class GloVeClass(nn.Module):
    ...
    def __init__(self, TOKENIZED_CORPUS, UNIQUE_WORD_LIST, EMBED_SIZE, CONTEXT_SIZE, X_MAX, ALPHA, TOTAL_PROCESS_NUM):
        ...
        print("[GloVeClass Initialization Done]")
